...
const Profile = () => {
  ...
  const updatePasswordSubmit = async (e) => {
    ...
    try {
      const res = await axios.put(myURL + "/api/v1/password/update", myForm, {
  ...
  return (
    <div className="grid grid-cols-1 h-full dark:bg-gray-900 dark:text-white">
      <div className="grid grid-cols-2  justify-between  py-2 dark:shadow-md dark:shadow-orange-600">
        <Sidebar />
        ...
        <div className="shadow-2xl shadow-black   mx-auto border border-green-600 dark:shadow-orange-600 dark:border-white rounded-md w-[70%] md:w-[40%] p-10 ">
          ...
          {vis && (
            <>
              ...
              <div className="  p-4">
                <form className="flex flex-col" onSubmit={updatePasswordSubmit}>
